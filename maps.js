// Initialize the map
var map1 = L.map('map1').setView([41.9100, 12.4845], 16); // Set center to Piazza del Popolo
...
var piazzaDelPopoloMarker = L.marker(piazzaDelPopoloCoor).addTo(map1);
piazzaDelPopoloMarker.bindPopup("<b>Piazza del Popolo</b><br>William Demby").openPopup();

// Marker for Rosati
var rosatiMarker = L.marker([41.9100, 12.4760]).addTo(map1);
rosatiMarker.bindPopup("<b>Rosati Cafe</b><br>Where many artists worked and shared ideas");

// Marker for Canova
var canovaMarker = L.marker([41.9103, 12.4771]).addTo(map1);
...
var polyline = L.polyline(latlngs, {color: 'red', dashArray: '5, 10'}).addTo(map1);
...
// Initialize the map
var map2 = L.map('map2').setView([41.9135, 12.4995], 15); 
...
var villaMarker = L.marker(villaBorgheseCoor).addTo(map2);
villaMarker.bindPopup("<b>Villa Borghese</b><br>Some artist");

// Via delle Botteghe Oscure, 32
var viaBottegheOscureMarker = L.marker(viaBottegheOscureCoor).addTo(map2);
viaBottegheOscureMarker.bindPopup("<b>Via delle Botteghe Oscure, 32</b><br>Ben Johnson");

// American Academy in Rome
var americanAcademyMarker = L.marker(americanAcademyCoor).addTo(map2);
